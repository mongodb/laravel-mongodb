...
class RelationsWithMongoIdTest extends TestCase
{
    public function setUp()
    {
        parent::setUp(); // TODO: Change the autogenerated stub
        config(['database.connections.mongodb.use_mongo_id' => true]);
    }

    public function tearDown()
    {
        Mockery::close();
        config(['database.connections.mongodb.use_mongo_id' => false]);
