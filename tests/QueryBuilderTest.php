...
class QueryBuilderTest extends TestCase
{
    ...
    public function testNoDocument()
    {
        ...
        $item = DB::collection('items')->where('id', '51c33d8981fec6813e00000a')->first();
        $this->assertNull($item);
    }
    ...
    public function testPush()
    {
        ...
        DB::collection('users')->where('id', $id)->push('tags', 'tag1');
        ...
        DB::collection('users')->where('id', $id)->push('tags', 'tag2');
        $user = DB::collection('users')->find($id);
        ...
        // Add unique
        DB::collection('users')->where('id', $id)->push('tags', 'tag1', true);
        $user = DB::collection('users')->find($id);
        $this->assertCount(3, $user->tags);

        $message = ['from' => 'Jane', 'body' => 'Hi John'];
        DB::collection('users')->where('id', $id)->push('messages', $message);
        $user = DB::collection('users')->find($id);
        ...
        // Raw
        DB::collection('users')->where('id', $id)->push([
            'tags' => 'tag3',
    ...
    public function testPull()
    {
        ...
        DB::collection('users')->where('id', $id)->pull('tags', 'tag3');
        ...
        DB::collection('users')->where('id', $id)->pull('messages', $message1);
        ...
        // Raw
        DB::collection('users')->where('id', $id)->pull(['tags' => 'tag2', 'messages' => $message2]);
        $user = DB::collection('users')->find($id);
        $this->assertCount(2, $user->tags);
    ...
    public function testCustomId()
    {
        ...
        $item = DB::collection('items')->where('id', 'fork')->first();
    ...
    public function testList()
    {
        ...
        $list = DB::collection('items')->pluck('name', 'id')->toArray();
        $this->assertCount(4, $list);
    ...
    public function testUpdateSubdocument()
    {
        ...
        DB::collection('users')->where('id', $id)->update(['address.country' => 'England']);
    ...
    public function testDates()
    {
        DB::collection('users')->insert([
            ...
            ['name' => 'Robert Roe', 'birthday' => new DateTimeImmutable('1982-01-01 00:00:00')],
            ['name' => 'Mark Moe', 'birthday' => new DateTime('1983-01-01 00:00:00.1')],
        ...
        $start = Date::parse('1950-01-01 00:00:00');
        $stop  = Date::parse('1981-01-01 00:00:00');
    ...
    public function testCursor()
    {
        ...
        $results = DB::collection('items')->orderBy('id', 'asc')->cursor();
